...
from sqlalchemy import ForeignKey, Float, DateTime, UniqueConstraint, Index
...
class ProviderExchangeRate(Base):
    ...
    # Unique constraint on provider_id, from_currency_id, to_currency_id to enforce uniqueness of exchange rates,
    # Makes impossible to create duplicate exchange rates
    __table_args__ = (
